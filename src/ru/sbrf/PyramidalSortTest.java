...
public class PyramidalSortTest {
    ...
    public static void main(String[] args) {
        ...
        final List<Duration> myPyramidalResult = benchmarkMyPyramidal(10);
        ...
        printResult(myPyramidalResult);
        printResult(mySortResult);
        printResult(sortFromBookResult);
        printResult(nativeSortResult);
    }

    private static List<Duration> benchmarkMyPyramidal(int amount) {
        ...
        for(int j = 0; j < 10; ++j)  {
            ...
            IntStream.range(0, 100).forEach(i -> PyramidalSort.sort(genArrays[i]));
