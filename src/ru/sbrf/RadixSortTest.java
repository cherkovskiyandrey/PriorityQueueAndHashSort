...
public class RadixSortTest {
    public static void main(String[] args) {
        ...
        final List<Duration> myRadixResult = benchmarkMyRadix(10);
...
//        printResult(sortFromBookResult);
    ...
    private static List<Duration> benchmarkMyRadix(int amount) {
        ...
        for(int j = 0; j < 10; ++j)  {
            ...
            IntStream.range(0, 100).forEach(i -> RadixSort.sort(genArrays[i]));
